...
| 15 | **Lock-in Harmonic Analyzer** | Ultra-low distortion measurement module utilizing the principle of a lock-in amplifier. It performs 10-parallel IQ detection strictly tuned to the fundamental and harmonics to extract minute distortion with high precision. |
