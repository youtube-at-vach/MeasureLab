...
class AudioEngine:
    ...
    def __init__(self):
        ...
        # Stream Configuration Snapshots (for master callback)
        self._stream_input_mode = None
    ...
    def _master_callback(self, indata, outdata, frames, time, status):
        ...
        # Retrieve captured stream configuration
        in_mode = self._stream_input_mode
        out_mode = self._stream_output_mode
    ...
    def _start_master_stream(self):
        ...
        # Snapshot configuration for the callback
        self._stream_input_mode = in_mode
        self._stream_output_mode = out_mode
