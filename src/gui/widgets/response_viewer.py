...
class ResponseViewerWidget(QWidget):
    ...
    def set_model_data(self, data):
        ...
        # Resolve structure, domain, algorithm
        structure_val = self.model_metadata.get("model_structure")
        domain_val = self.model_metadata.get("model_domain")
        algorithm_val = self.model_metadata.get("model_algorithm")
        ...
        if not structure_val:
            if "Lock-in Modeler" in module_name:
                ...
                if num_amps > 1:
                    structure_val = "classical_hammerstein"
                else:
                    structure_val = "generalized_hammerstein"
            elif "Nonlinear Analyzer" in module_name:
                structure_val = "generalized_hammerstein"
            else:
                structure_val = "unknown"
