...
### ☕ コーヒーブレイク：ノイズを「身近な音」で例えると？

一言で「ノイズ」と言っても、原因によって音のキャラクターが全く違います。
スペクトラムやプロファイラーで分析する前に、耳で聞いてどんな音かを想像してみましょう。

* **ホワイトノイズ (White)**: 「サーーー」という音。テレビの砂嵐や、**「激しい雨の音」**に似ています。全ての高さの音が均等に混ざっています。
* **ピンクノイズ / 1/fノイズ**: 「ザーーー」という音。ホワイトノイズより少し低音が強く、**「滝の音」**や**「波の音」**に似ています。自然界に多く存在し、人間の心拍などもこの1/fゆらぎを持っています。
* **ハムノイズ (Hum)**: 「ブーン」という低い音。**「古い冷蔵庫の音」**や**「変電所の近くの音」**に似ています。コンセントから来る交流電気の周波数（東日本なら50Hz、西日本なら60Hz）がそのまま混入したものです。

これらの違いを知っていると、グラフを見ただけで「あ、これは冷蔵庫系のノイズ（ハム）だな！」と原因が直感的にわかるようになります。
