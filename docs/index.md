...
「音」は空気の震えです。私たちはそれを耳で聞いていますが、どんな形をしているのか、どんな成分が混ざっているのかは、耳だけでは正確に分かりません。
MeasureLab は、見えない「音」をグラフにしてスクリーンに映し出すツールです。
例えるなら、病院の「心電図」や、星を観察する「天体望遠鏡」のようなもの。あなたのパソコンが、目に見えない音の姿を映し出す魔法の鏡に変わります！
