...
### 1. ソフトウェアのインストール
ソフトウェアが起動できる状態になっている必要があります。まだの方や、OSごとの注意点を知りたい方は [**クイックスタート：起動編**](quickstart.md#1-ソフトウェアを起動する) をご覧ください。
...
- [**トラブルシューティング**](appendix.md#5-2-トラブルシューティング（困ったときは）)
- [**付録：このツールの限界と注意点**](appendix.md#5-1-このツールは「測定器」ではありません)
