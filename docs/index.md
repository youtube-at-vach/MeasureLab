...
* [クイックスタート](quickstart.md): 初めて使う方向け
* [**ウィジェットの説明**](widget_guide.md): 特定の機能を使いたい方向け
* [**測定レシピ**](measurement_recipes/index.md): 実際の測定例を知りたい方向け
...
出力信号を入力へ直接戻す **「ループバック（折り返し）接続」** での動作確認をお勧めします。
