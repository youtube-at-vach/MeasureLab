...
## ☕ コーヒーブレイク：特定の信号だけを「拾い上げる」ロックイン検波

ロックインアンプは、ノイズだらけの環境から特定の相手の声だけを聞き取るような働きをします。測定したい信号と同じ周波数・位相の「参照信号」を用意し、両者を掛け合わせることで、無関係なノイズ成分を数学的に排除します。これにより、ノイズフロアよりも遥かに小さな微弱信号を驚くほど正確に「拾い上げる（ロックインする）」ことが可能になります。
