...
💡 **声紋ってなに？**
人間の声や鳥の鳴き声などをこのグラフで見ると、まるで指紋のように「その音特有の模様」が浮かび上がります。これを声紋と呼びます。例えば「あ」と「い」では、口の形が違うため響きやすい高さ（周波数）が変わり、グラフ上の模様もハッキリと変化します。警察の捜査で犯人の声を分析するのにも、これと同じ原理が使われています。
