...
## ☕ コーヒーブレイク：大きすぎる音を「引き算」する理由

例えば、あなたが1kHz（ピーという音）をテストで鳴らしたとします。アンプが歪むと、その音の中に2kHzや3kHzといった「にごり（歪み）」が混ざります。
しかし、大元の1kHzが大きすぎるため、小さな「にごり」は完全に隠れて見えなくなってしまいます。まるで太陽が眩しすぎて、隣にある小さな星が見えないようなものです。
そこで、このウィジットは「入力された1kHzと全く同じ1kHzを合成し、引き算して（太陽を隠して）消してしまう」という荒業を行います。残った音（夜空）だけを見れば、どれだけ小さな歪み（星）でも正確に測れるというわけです！
