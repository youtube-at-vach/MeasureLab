...
## ☕ コーヒーブレイク：イヤホンで「後ろ」から音が聞こえる不思議

ステレオのイヤホンは「左」と「右」にしかスピーカーがないのに、なぜ最新のゲームやVRでは音が「後ろ」や「上」から聞こえるのでしょうか？

実は私たちの「耳たぶ（耳介）」は、とても複雑な形をしていますよね。音が後ろから来た時と、前から来た時では、この複雑な耳たぶに音がぶつかって反射するパターン（音質の変化）が微妙に異なります。脳は長年の経験から「あ、こういう音の曇り方をした時は後ろから音が来ているな」と学習しているのです。
**HRTF（頭部伝達関数）** は、この「前から来た時はこういう音質に変化する」「後ろから来た時はこう変化する」という耳たぶや頭の反射のパターンを記録したデータです。普通の音にこのHRTFのデータを「掛け算」してイヤホンで鳴らすと、脳が騙されて「後ろから鳴っている！」と錯覚するのです。HRTF Playerは、その魔法のデータの中身を覗き見るためのツールです。
