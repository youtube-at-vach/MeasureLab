...
普通の「周波数カウンター」が「今はだいたい1000Hzですね」と教えてくれるものだとしたら、このウィジェットは「今は1000.000001Hzで、さっきより0.000001Hzズレましたよ！」と教えてくれる「超精密なルーペ」です。
例えば、レコードプレーヤーのターンテーブルがほんの少しだけ遅くなったり早くなったりする揺れ（ワウ・フラッター）や、機材が温まってきて少しだけ音がズレていく様子（温度ドリフト）など、普通は見逃してしまうようなミクロな変化を、逃さず捉えることができます。
