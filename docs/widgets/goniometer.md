...
## ☕ コーヒーブレイク：音の万華鏡「リサージュ図形」

ゴニオメーターの画面で踊る不思議な模様、これは数学の世界で「リサージュ図形」と呼ばれるものです。
左から聞こえる音を「タテの揺れ」、右から聞こえる音を「ヨコの揺れ」として、1つのペンで同時に描画すると、このような模様が生まれます。

両方の耳に全く同じ音が届くと、斜め45度の「まっすぐな1本の線」になります。しかし、左右の音に少しずつ違い（広がりや奥行き）が生まれると、線は円になり、複雑に絡み合い、まるで「音の万華鏡」のように美しく変化します。
この魔法の窓を覗き込めば、ミュージシャンやエンジニアが空間にどのように音を散りばめたのか、その「ステレオの秘密」が手に取るようにわかります！
