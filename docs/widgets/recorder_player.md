...
## ☕ コーヒーブレイク：なぜ測定に「録音」が必要なの？

測定ツールを使っているのに、なぜ「録音（レコーダー）」機能があるのでしょうか？
それは、音のトラブルがいつも行儀よく起きるとは限らないからです！

例えば、「アンプから時々、パチッ！という謎のノイズが出る」という問題があったとします。
オシロスコープの画面を何時間もじーっと見つめて、一瞬の「パチッ！」を待ち続けるのは大変ですよね。まばたきした瞬間に見逃してしまうかもしれません。

そんな時は、このレコーダーの出番です！
疑わしい機械の音をひたすら録音しておけば、あとから「パチッ！」と鳴った部分だけをゆっくり再生したり、別のツールでその波形を心ゆくまで拡大して「犯人探し」をすることができます。
録音機能は、あなたの実験室に設置する**「音の防犯カメラ」**のようなとても心強い存在なのです！
