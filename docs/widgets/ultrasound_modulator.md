...
## ☕ コーヒーブレイク：超音波でどうやって音を伝えるの？

人間の耳には聞こえないはずの「超音波（とても高いピッチの音）」を使って、どうやって普通の音楽や声を届けるのでしょうか？
実は、超音波を「運び手（キャリア）」にして、その背中に音楽を乗せているのです（これが変調です）。超音波は光のようにまっすぐ進む性質があり、空気中を飛んでいくうちに自然と背中の音楽が「こぼれ落ちて」聞こえるようになります。
これを利用したのが「パラメトリックスピーカー」です。美術館などで、特定の場所に立つと突然説明のアナウンスが聞こえる不思議な体験をしたことはありませんか？ まさにあの魔法を作っているのが、このウィジェットのような技術なのです！
