...
過去の音楽制作では、他の曲より目立たせるために限界まで音量を上げる「音圧戦争」が起きていました。しかし曲ごとに音量が違うと、リスナーは頻繁な音量調整を強いられます。
そこで、機械的なピーク値ではなく「人間の耳が感じるうるささ」を基準にするLUFSが作られました。現在ではYouTubeやSpotifyなども、LUFSを基準にすべての曲が同じ聴きやすい音量になるよう自動調整（ノーマライゼーション）を行っています。
