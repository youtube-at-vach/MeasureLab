...
かつて音楽業界では、目立たせるために音量を上げる「音圧戦争」がありましたが、曲ごとの音量差はリスナーにとって不便でした。そこで、機械的なピーク値ではなく「人間の耳が感じるうるささ」を基準に音量を揃えるために作られた規格が **LUFS** です。現在、各種配信サービスではLUFSを用いた音量の自動調整が行われています。
