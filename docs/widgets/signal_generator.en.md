...
With complex music signals, it is difficult to accurately quantify the minute distortion or noise generated by the equipment itself.
By inputting a pure sine wave as a "reference," any unwanted components mixed into the output can be clearly separated and measured.
