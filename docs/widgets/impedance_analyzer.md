...
## ☕ コーヒーブレイク：抵抗とインピーダンスの違い

「抵抗」は直流電流に対する流れにくさを表します。
一方「インピーダンス」は、交流電流に対する流れにくさです。
コンデンサやコイルなどの部品は、信号の周波数（変化の速さ）によって流れにくさが変わるため、常に波打つオーディオ信号（交流）の測定においては、このインピーダンスを測ることが重要になります。
