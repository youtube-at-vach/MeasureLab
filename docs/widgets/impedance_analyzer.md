...
## ☕ コーヒーブレイク：抵抗とインピーダンスの違いって？

「抵抗」は、重い箱を一定の力でズリズリと押し続けるときの「摩擦」のようなものです。
一方「インピーダンス」は、その重い箱を**「前後に激しく揺さぶる」**ときの動かしにくさです。
箱が重ければ重いほど（コイルのように）、またはバネが硬ければ硬いほど（コンデンサのように）、素早く揺さぶるには大きなエネルギーが必要になります。
音楽などのオーディオ信号は常にプラスとマイナスが入れ替わる「波（交流）」なので、ただの摩擦（抵抗）だけでなく、この「揺さぶりにくさ（インピーダンス）」を測ることがとても重要なのです！
