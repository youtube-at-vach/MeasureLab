...
「抵抗」は一定の力で押し続けるときの「摩擦」のようなものです。
一方「インピーダンス」は、「前後に激しく揺さぶる」ときの動かしにくさです。
重さ（コイル）やバネの硬さ（コンデンサ）によって、素早く揺さぶるのに必要なエネルギーが変わります。
オーディオ信号は常に波打つ「交流」なので、この「揺さぶりにくさ」を測ることが重要です。
