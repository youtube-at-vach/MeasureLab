...
4. Repeat each load at least once to estimate run-to-run scatter. Enter a **Prediction load** to see the voltage-divider prediction relative to A. Save the results and conditions with **Save load study CSV...**.
