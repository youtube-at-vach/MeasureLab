...
## ☕ コーヒーブレイク：音の「顕微鏡プレパラート」を作る

理科の実験で、見たいものをプレパラート（ガラス板）に挟んで顕微鏡で見ましたよね。
このツールはまさにそれです！ 長い録音データの中から、「ここだ！」という一瞬（ドラムのキック音や、ノイズが入った瞬間）だけを切り取って、何度も何度も繰り返し再生（ループ）させます。
そうすることで、オシロスコープやスペクトラムアナライザといった他の「顕微鏡」を使って、その一瞬の音をじっくりと観察することができるのです。
