...
* **Module Search**: Enter a module name in **Search modules** to filter the sidebar. Both English names and translated names are matched.
* **Recently Opened**: The Welcome page provides quick links to up to four recently opened modules.
...
* **Setup Guidance and Tool Preview**: Provides quick links for audio setup and lists the major measurement functions of MeasureLab (Spectrum Analyzer, Signal Generator, Oscilloscope, etc.).
