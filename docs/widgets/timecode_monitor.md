...
タイムコード（LTC）を音声としてスピーカーで鳴らすと、「ピーピー」「ジジジ」というモデムのような耳障りな音がします。しかし、この信号には `時:分:秒:フレーム` という正確な時間情報が含まれています。この音声を複数のカメラや録音機に記録しておくことで、後の編集作業においてソフトウェアが音声を基準にしてタイムラインを全自動で同期できるようになります。
