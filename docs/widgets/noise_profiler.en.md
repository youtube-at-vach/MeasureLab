...
#### 1. Noise Spectrum (Central Graph)
...
#### 2. Noise Contribution (Bottom Bar Graph)
...
### 1. Self-Noise Measurement of Microphone Preamplifiers
...
### 2. Evaluation of Power Supply Noise
...
### 3. Observation of Thermal Noise of Resistors (Experiment)
