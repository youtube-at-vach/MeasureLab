...
*   **Windows**: Builds the `onedir` bundle with ASIO helper scripts, packages it as an Inno Setup installer, and publishes the installer and folder-based ZIP `.github/workflows/release.yml:47-86`.
...
*   **Scan Logic**: Downloads the Windows installer and folder-based ZIP together with the Linux and macOS assets, then submits them to the VirusTotal API v3 `.github/workflows/virustotal.yml:84-148`.
