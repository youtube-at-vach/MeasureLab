...
TRANSLATION_MAP = {
    ...
    "Amp Sweep": {
        "de": "Amplitudensweep",
        "es": "Barrido de amplitud",
        "fr": "Balayage d'amplitude",
        "ko": "진폭 스위프",
        "pt": "Varredura de amplitude",
        "ru": "Амплитудный свип",
        "zh": "振幅扫频",
    },
    "Amplitude": {
    ...
    "Articulation Index": {
        "de": "Artikulationsindex",
        "es": "Índice de articulación",
        "fr": "Indice d'articulation",
        "ko": "명료도 지수 (AI)",
        "pt": "Índice de articulação",
        "ru": "Индекс артикуляции (AI)",
        "zh": "清晰度指数 (AI)",
    },
    "Auto": {
        "de": "Automatisch",
    ...
    "Diff from target": {
        "de": "Abweichung vom Sollwert",
        "es": "Diferencia del objetivo",
        "fr": "Différence par rapport à la cible",
        "ko": "타겟과의 편차",
        "pt": "Diferença do alvo",
    ...
    "Duration": {
        "de": "Messdauer",
        "es": "Duración de medición",
        "fr": "Durée de mesure",
        "ko": "측정 시간",
        "pt": "Duração da medição",
        "ru": "Время измерения",
        "zh": "测量时间",
    },
    "Excellent": {
    ...
    "Loudness Range": {
        "de": "Lautheitsbereich",
        "es": "Rango de sonoridad",
        "fr": "Plage de loudness",
        "ko": "라우드니스 범위",
        "pt": "Faixa de sonoridade",
        "ru": "Диапазон громкости",
        "zh": "响度范围",
    },
    "None": {"de": "Keine", "es": "Ninguno", "fr": "Aucun", "ko": "없음", "pt": "Nenhum", "ru": "Нет", "zh": "无"},
    "None (Instant)": {
        "de": "Keine (sofort)",
        "es": "Ninguno (instantáneo)",
        "fr": "Aucun (instantané)",
        "ko": "없음 (즉시)",
        "pt": "Nenhum (imediato)",
        "ru": "Нет (мгновенно)",
    ...
    "Secondary Y": {
        "de": "Sekundäre Y-Achse",
        "es": "Eje Y secundario",
        "fr": "Axe Y secondaire",
        "ko": "보조 Y축",
        "pt": "Eixo Y secundário",
        "ru": "Вспомогательная ось Y",
        "zh": "辅助 Y 轴",
    },
    "Start": {
        "de": "Starten",
    ...
    "Zoom to Selection": {
        "de": "Auf Auswahl zoomen",
        "es": "Ajustar zoom a la selección",
        "fr": "Zoomer sur la sélection",
        "ko": "선택 영역으로 확대",
        "pt": "Zoom para a seleção",
        "ru": "Масштабировать по выделению",
        "zh": "缩放到选择",
    },
}
