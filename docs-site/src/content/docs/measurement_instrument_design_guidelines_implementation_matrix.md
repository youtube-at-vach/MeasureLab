---
title: "MeasureLab GUI Design Guideline 対応状況マトリクス"
---
...
- **根拠:** `src/gui/widgets/settings.py`、`docs-site/src/content/docs/widgets/settings.md`、`tests/logic_verification/gui/test_settings_structure.py`、`tests/logic_verification/gui/widgets/test_settings_calibration_profiles.py`
...
- **根拠:** `src/gui/widgets/welcome.py`、`docs-site/src/content/docs/widgets/welcome.md`、`tests/logic_verification/gui/widgets/test_welcome.py`
...
- **根拠:** `src/gui/measurement_console.py`、`docs-site/src/content/docs/widgets/measurement_console.md`、`tests/logic_verification/gui/test_measurement_console.py`
