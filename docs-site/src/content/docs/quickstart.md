...
**初回起動時（FFT 最適化について）：** 初回起動時、測定の計算を高速化するための準備（[WISDOM](https://youtube-at-vach.github.io/MeasureLab/glossary/#fft-wisdom-初期最適化)の生成）が行われます。数十秒ほど画面が止まったようになることがありますが、異常ではありません。次回以降はキャッシュが使われ、すぐに起動します。
...
- **正確な電圧や音圧を測りたい** → [キャリブレーション](https://youtube-at-vach.github.io/MeasureLab/calibration/)
- **どのツールを使えばいいか迷ったら** → [ウィジェットガイド](https://youtube-at-vach.github.io/MeasureLab/widget_guide/)
- **実際の測り方を知りたい** → [測定レシピ](https://youtube-at-vach.github.io/MeasureLab/measurement_recipes/)
- **波形を直接見たい** → [Oscilloscope](https://youtube-at-vach.github.io/MeasureLab/widgets/oscilloscope/)
