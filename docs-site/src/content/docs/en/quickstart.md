...
**First launch (FFT Optimization):** On the first launch, preparation ([WISDOM](https://youtube-at-vach.github.io/MeasureLab/en/glossary/#fft-wisdom-initial-optimization) generation) is performed to speed up measurement calculations. The screen may appear to freeze for several tens of seconds, but it is not a malfunction. From the next time, the cache will be used, and it will start instantly.
...
- **To measure accurate voltage or SPL** → [Calibration](https://youtube-at-vach.github.io/MeasureLab/en/calibration/)
- **If you are unsure which tool to use** → [Widget Guide](https://youtube-at-vach.github.io/MeasureLab/en/widget_guide/)
- **To know how to measure in practice** → [Measurement Recipes](https://youtube-at-vach.github.io/MeasureLab/en/measurement_recipes/)
- **To see the waveform directly** → [Oscilloscope](https://youtube-at-vach.github.io/MeasureLab/en/widgets/oscilloscope/)
