---
title: "Audio Device Distortion (THD+N) Measurement"
---
...
If you want to measure ultra-high performance DACs and amplifiers that fall below -150dB, consider using the **[LockinHarmonicAnalyzer](https://youtube-at-vach.github.io/MeasureLab/en/widgets/lockin_harmonic_analyzer/)**. By using the lock-in method, it is possible to observe even deeper noise floors, but for normal measurements, this Distortion Analyzer provides sufficient performance.
