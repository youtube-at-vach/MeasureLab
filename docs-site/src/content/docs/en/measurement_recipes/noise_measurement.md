...
| :--- | :--- | :--- |
| **View noise spectrum** | [Spectrum Analyzer](https://youtube-at-vach.github.io/MeasureLab/en/widgets/spectrum_analyzer/) | Confirm at which frequencies and how much noise is included (distribution). This is the most common measurement. |
| **Analyze noise types** | [Noise Profiler](https://youtube-at-vach.github.io/MeasureLab/en/widgets/noise_profiler/) | Decompose into components such as "hiss (white noise)" and "hum," and quantify their respective contributions. |
| **View time-series changes in noise** | [Raw Time Series](https://youtube-at-vach.github.io/MeasureLab/en/widgets/raw_time_series/) | Monitor changes over time, such as "occasional pop noise" or "fluctuation of DC offset." |
| **Count rare abnormal noise** | [Event Detector](https://youtube-at-vach.github.io/MeasureLab/en/widgets/event_detector/) | Measure the count and rate of popcorn-noise or RTN events. |
