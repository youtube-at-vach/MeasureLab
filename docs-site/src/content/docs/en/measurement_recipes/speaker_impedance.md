---
title: "Speaker Impedance Measurement"
---

## Overview

:::caution
This guide was created based on AI inference. Please be sure to read [**Appendix: This tool is not a "measuring instrument"**](https://youtube-at-vach.github.io/MeasureLab/en/appendix/) regarding the reliability of measurement results and the limitations of this tool.
:::
