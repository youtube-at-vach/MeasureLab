...
The widget supports the Detachable Wrapper's detached, split, and compact states. See [Detachable Wrapper](https://youtube-at-vach.github.io/MeasureLab/en/widgets/detachable_wrapper/) for details.
