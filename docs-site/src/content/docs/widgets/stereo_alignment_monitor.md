---
title: "Stereo Alignment Monitor (ステレオ・アライメント・モニター)"
---
...
ステレオ再生において、左右のスピーカーからリスナーへ届く音の状態が一致していることを「アライメント（整合性）が取れている」と言います。アライメントの崩れには主に以下の症状があります。

* **音量バランスのズレ**: 音が片方に偏って聞こえます。
* **位相のズレ**: 音の到達タイミングがずれ、音像がぼやけたり不自然に聞こえたりします。
* **位相反転**: 左右の波形が打ち消し合い、音がスカスカになります。

本ツールは、これらのズレを視覚的に監視することで、スピーカーセッティングの正確さの確認やトラブルシューティングを支援します。
