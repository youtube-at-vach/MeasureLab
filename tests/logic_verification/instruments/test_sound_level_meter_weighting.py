...
def test_a_weighting_response(slm):
...
def test_c_weighting_response(slm):
...
def test_bw_filter_response(slm):
...
def test_z_weighting_response(slm):
...
def test_filter_application_via_callback(slm):
